            ...
            try {
              ...
              return {
                ...
                delivery: {
                  ...
                  fromAddress: deliveryResponse.data.fromLocation?.address || 'N/A',
                  fromCity: deliveryResponse.data.fromLocation?.city || '',
                  toAddress: deliveryResponse.data.toLocation?.address || 'N/A',
                  toCity: deliveryResponse.data.toLocation?.city || '',
