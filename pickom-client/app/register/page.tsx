...
export default function RegisterPage() {
  ...
  const handleRegister = async () => {
    ...
    // After successful registration, redirect to delivery methods
              ...
              <Stack direction="row" spacing={2} sx={{ mt: 3 }}>
                ...
                {userType === UserType.SENDER ? (
                  <Button
                    ...
                    disabled={!isUserDataComplete() || Object.values(state.errors).some(error => !!error)}
                    fullWidth
                  >
                    Create Account
                  </Button>
