...
export class CreateDeliveryDto {
  ...
  // Адрес откуда забрать посылку (обязательное поле)
  // Пример: "ул. Ленина 10, Минск"
  @IsString()
  @IsNotEmpty()
  fromAddress: string;

  // Адрес куда доставить посылку (обязательное поле)
  // Пример: "пр. Победителей 5, Минск"
  @IsString()
  @IsNotEmpty()
  toAddress: string;

  // Цена доставки (обязательное поле, должна быть >= 0)
  // Пример: 15.50
  @IsNumber()
  @Min(0)
  price: number;
