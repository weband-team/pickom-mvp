...
export class NotificationService {
  ...
  async notifyOfferReceived(senderId: string, deliveryId: number, pickerName: string, price: number): Promise<Notification> {
  ...
  async notifyOfferAccepted(senderId: string, deliveryId: number): Promise<Notification> {
    return await this.createNotification({
      user_id: senderId,
  ...
  async notifyIncomingDelivery(recipientId: string, deliveryId: number, senderName: string): Promise<Notification> {
    return await this.createNotification({
      user_id: recipientId,
  ...
  async notifyStatusUpdate(userId: string, deliveryId: number, status: string, message: string): Promise<Notification> {
